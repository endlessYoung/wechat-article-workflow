...
[中文文档](./README.zh-CN.md) · [Skill Manual](./SKILL.md) · [Architecture](./docs/architecture.md) · [Theme Guide](./docs/theme-guide.md) · [Practice playbook](./docs/how-it-was-built.md)
